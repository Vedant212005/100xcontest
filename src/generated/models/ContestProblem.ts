...
export type ContestProblemWhereInput = {
  ...
  contestId?: Prisma.UuidFilter<"ContestProblem"> | string
  problemId?: Prisma.UuidFilter<"ContestProblem"> | string
  points?: Prisma.IntFilter<"ContestProblem"> | number
...
export type ContestProblemScalarWhereWithAggregatesInput = {
  ...
  contestId?: Prisma.UuidWithAggregatesFilter<"ContestProblem"> | string
  problemId?: Prisma.UuidWithAggregatesFilter<"ContestProblem"> | string
  points?: Prisma.IntWithAggregatesFilter<"ContestProblem"> | number
}
...
export type ContestProblemOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"contestId" | "problemId" | "points", ExtArgs["result"]["contestProblem"]>
...
export interface ContestProblemDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const contestProblemWithContestIdOnly = await prisma.contestProblem.findMany({ select: { contestId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ContestProblems and only return the `contestId`
   * const contestProblemWithContestIdOnly = await prisma.contestProblem.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more ContestProblems and only return the `contestId`
   * const contestProblemWithContestIdOnly = await prisma.contestProblem.updateManyAndReturn({
   *   select: { contestId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ContestProblemFieldRefs {
  ...
  readonly points: Prisma.FieldRef<"ContestProblem", 'Int'>
}
